...
-- Selects a directory to cwd in after starting a picker session
...
local ts_select_cwd_for_pkr = function(pkr)
        ...
        opts = {
            pickers = {
                ...
                live_grep = {
                    mappings = {
                        i = {
                            ["<C-f>"] = function(p) ts_select_cwd_for_pkr(require("telescope.builtin").live_grep)(p) end,
                        },
                        n = {
                            ["<C-f>"] = function(p) ts_select_cwd_for_pkr(require("telescope.builtin").live_grep)(p) end,
                        }
